...
"[project]/src/app/HomeFeed.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getRelativeTime = (dateString)=>{
    ...
    if (diffMin < 60) return "".concat(diffMin, " minute").concat(diffMin > 1 ? "s" : "", " ago");
    if (diffHour < 24) return "".concat(diffHour, " hour").concat(diffHour > 1 ? "s" : "", " ago");
    if (diffDay === 1) return "Yesterday";
    if (diffDay < 7) return "".concat(diffDay, " day").concat(diffDay > 1 ? "s" : "", " ago");
...
function HomeFeed() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomeFeed.useEffect": ()=>{
            const fetchPostsAndUsers = {
                "HomeFeed.useEffect.fetchPostsAndUsers": async ()=>{
                    try {
                        // 1. Fetch posts
                        ...
                        const ids = [
                            ...new Set(data.map({
                                "HomeFeed.useEffect.fetchPostsAndUsers": (p)=>p.owner_id
                            }["HomeFeed.useEffect.fetchPostsAndUsers"]))
                        ];
                        if (ids.length > 0) {
                            // 3. Fetch all users in one call (bulk fetch)
                            const userRes = await fetch("/api/users?ids=".concat(ids.join(",")));
                            const usersData = await userRes.json();
                            console.log("Fetched users data:", usersData);
                            // --- DEBUG: Log fetched users ---
                            usersData.forEach({
                                "HomeFeed.useEffect.fetchPostsAndUsers": (u)=>{
                                    console.log("User ID: ".concat(u._id, ", Name: ").concat(u.name));
                                }
                            }["HomeFeed.useEffect.fetchPostsAndUsers"]);
                            // 4. Map users by ID
                            const userMap = {};
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...Array(3)
                    ...
                    className: "bg-white shadow rounded-xl p-4 animate-pulse",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "h-4 bg-gray-200 rounded w-1/3 mb-2"
                        }, void 0, false, {
                            fileName: "[project]/src/app/HomeFeed.tsx",
                            lineNumber: 70,
                            columnNumber: 13
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex w-full max-w-2xl flex-col space-y-6 mt-8",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                className: "text-3xl font-bold text-gray-800 mb-4 justify-self-start",
                children: "Feed"
            }, void 0, false, {
                fileName: "[project]/src/app/HomeFeed.tsx",
                lineNumber: 88,
            ...
            posts.map((post)=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        uploader && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: uploader.given_name + " " + uploader.family_name || "User"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/HomeFeed.tsx",
                                            lineNumber: 113,
                                            columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: getRelativeTime(post.createdAt)
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/HomeFeed.tsx",
                                            lineNumber: 114,
                                            columnNumber: 19
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                            ...
                            children: [
                                ...
                                post.image && // eslint-disable-next-line @next/next/no-img-element
...
_s(HomeFeed, "ME1MU8uTczk+EsQgLQ3yf2sUEkk=");
_c = HomeFeed;
var _c;
...
//# sourceMappingURL=_5693d812._.js.map