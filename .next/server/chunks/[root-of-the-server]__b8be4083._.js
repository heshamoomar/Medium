...
"[project]/src/app/lib/cloudinary.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/app/lib/cloudinary.ts [app-route] (ecmascript) <locals>");
;
;
;
;
    ...
    try {
        ...
        if (file) {
            ...
            const uploadResponse = await new Promise((resolve, reject)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].uploader.upload_stream({
                    folder: "posts"
                }, (error, result)=>{
        ...
        const newPost = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$models$2f$Post$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            owner_id,
            title,
            description,
            content,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(plainPost, {
            status: 201
        });
    } catch (err) {
...
async function GET(req) {
    try {
        ...
        const posts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$models$2f$Post$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find().sort({
            createdAt: -1
        }).lean(); // newest first
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8be4083._.js.map