...
/* __next_internal_action_entry_do_not_use__ [{"407662ee86733a498a4d3a604d53b6fc5d9e97d35f":"GET"},"",""] */ __turbopack_context__.s([
    "GET",
    ()=>GET
]);
...
async function GET(request) {
    try {
        ...
        const ids = idsParam.split(",").filter((id)=>__TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Types.ObjectId.isValid(id));
        if (ids.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            _id: {
                $in: ids
            }
        }).lean();
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(GET, "407662ee86733a498a4d3a604d53b6fc5d9e97d35f", null);
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__027c535c._.js.map